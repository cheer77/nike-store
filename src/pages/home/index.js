...
import TechSpotlight from '../../components/TechSpotlight/tech-spotlight';
import OutfitBuilder from '../../components/OutfitBuilder/outfit-builder';
...
const techSpotlight = new TechSpotlight();
const outfitBuilder = new OutfitBuilder(cart, updateApp);
...
main.append(techSpotlight.render());
main.append(outfitBuilder.render());
